...
import java.rmi.AlreadyBoundException; //stop rebinding
import java.rmi.Naming; //store the refferences of the remote objects
import java.lang.SecurityManager; //handles the policies(securities)
...
public class MathServer extends UnicastRemoteObject implements MathService{
    ...
    public synchronized int clientCounter() throws RemoteException{
